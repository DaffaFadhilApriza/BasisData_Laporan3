...
2. Tabel Nasabah :
<img width="726" alt="image" src="https://github.com/DaffaFadhilApriza/BasisData_Laporan3/assets/131609626/bc1438db-9643-409b-8433-11e27d09508b">

Gambar diatas adalah tampilan dari struktur tabel nasabah yang telah dibuat pada phpmyadmin. Pada tabel ini terdapat variabel id_nasabah, no_rekening, nama, no_telepon, alamat, email, tanggal_lahir, jenis_kelamin, dan pekerjaan. Primary key pada tabel tersebut adalah id_nasabah. Foreign key pada tabel tersebut adalah no_rekening.

<img width="812" alt="image" src="https://github.com/DaffaFadhilApriza/BasisData_Laporan3/assets/131609626/3be7065d-5e81-41ce-802d-c5683ce84532">

Gambar diatas adalah tampilan data pada tabel nasabah yang telah dibuat.

3. Tabel Petugas Bank :
<img width="724" alt="image" src="https://github.com/DaffaFadhilApriza/BasisData_Laporan3/assets/131609626/154f9c8e-adc1-4fa7-8d66-436947d0fd80">

Gambar diatas adalah tampilan dari struktur tabel petugas bank yang telah dibuat pada phpmyadmin. Pada tabel ini terdapat variabel id_petugas, nama, jabatan, no_telepon, dan jenis_kelamin. Primary key pada tabel tersebut adalah id_petugas.

<img width="470" alt="image" src="https://github.com/DaffaFadhilApriza/BasisData_Laporan3/assets/131609626/5479bfbe-f30a-4b82-b5ea-016ea95ae5aa">

Gambar diatas adalah tampilan data pada tabel petugas bank yang telah dibuat.

4. Tabel Rekening :
<img width="725" alt="image" src="https://github.com/DaffaFadhilApriza/BasisData_Laporan3/assets/131609626/9b4cbde7-389b-4309-b1e4-29242a12c61d">

Gambar diatas adalah tampilan dari struktur tabel rekening yang telah dibuat pada phpmyadmin. Pada tabel ini terdapat variabel no_rekening, jenis_rekening, saldo. Primary key pada tabel tersebut adalah no_rekening.
